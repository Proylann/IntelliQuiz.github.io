...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    // Method to insert a new user with score
    ...
    fun getAllUsersWithScores(): List<Pair<String, Int>> {
        ...
        db.close() // Close database connection
        return userList // Return the list of usernames and scores
    }
    fun getUserByUsername(username: String): String? {
        ...
        return user // Return the username if found, otherwise return null
    }

    // Method to update the score of an existing user
